...
The contestant's score is computed two days following the submission of the Sharpe Ratio and is based on the return of the user's top 200 and bottom 200 stocks.  The top 200 stocks are bought and the bottom 200 are shorted on the close of the business day after the Sharpe Ratio is predicted and sold at the close of the following trading day.
...
For an individual investor, their may be a business opportunity.  However, for the JPX Stock Exchange, there is a huge benefit to providing institutional investors with models that increase the likelihood that they can make money by trading daily as this could dramatically increase the volume of trades, and thereby revenue.

This competition seems likely to yield a number of models that make money trading on a daily basis.
...
## ARIMA and Prophet
[LSTM Neural Network Final Notebook](https://)
[LSTM Neural Network Final Notebook](https://)
...
### Visual 1
![ARIMA Model for Stock 9663](https//  )
...
### Visual 2
![LSTM with Dense Layer for Stock 9663](https://)
...
### Visual 3
![Single Random Forest Model for Stock 9663](https://github.com/jpeto)

### Visual 4
![Individual Random Forest Model for Stock 9663](https://)
...
### Visual 6 
![Kaggle Scores](https://github.com/jp)
